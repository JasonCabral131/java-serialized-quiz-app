 ...
 * @author Jason
 */
public class QuizInsaneLevel extends javax.swing.JFrame {
 ...
 String showDate()
                          ...
                          if(Score < 1){
                              if(!alreadyShow){
                                  ...
                                  String date = showDate();
                                   quizResult = new QuizResult(username, ScoreTotal, date, "insane" );
    ...
    private void initComponents() {
        ...
        jPanel1.add(heart3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 70, -1, -1));
        ...
        jPanel1.add(heart2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 70, -1, -1));
        ...
        jPanel1.add(heart1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 70, -1, -1));
        ...
        jPanel1.add(btn_next, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 610, 210, 50));
  ...
  ProfileViewer pv =     new ProfileViewer();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuizInsaneLevel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
