 ...
 * @author Jason
 */
public class ShowEasy extends javax.swing.JFrame {
 ...
 void showDate()
    ...
    private void initComponents() {
        ...
        jpl_Home.add(lbl_Home, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 320, 110));
        ...
        jPanel1.add(btn_view, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 210, 180, 50));
        ...
        tbl_showQuiz.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "QUIZ ID", "QUESTION", "CHOICE 1", "CHOICE 2", "CHOICE 3", "CHOICE 4", "Answer"
            }
        ));
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8-delete-22.png"))); // NOI18N
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 210, 180, 50));
        ...
        jPanel1.add(Background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1550, 730));
    ...
    private void btn_viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_viewActionPerformed
            if(tbl_showQuiz.getSelectionModel().isSelectionEmpty()){
               ...
               new Model().level = "EasyQuestion.ser";
                    System.out.println( new Model().quizID);
                     System.out.println( new Model().level);
 ...
 ProfileViewer pv =     new ProfileViewer();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
