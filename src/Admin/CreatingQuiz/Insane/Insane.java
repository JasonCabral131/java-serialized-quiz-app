...
package Admin.CreatingQuiz.Insane;
 ...
 * @author Jason
 */
public class Insane extends javax.swing.JFrame {
 ...
 void showDate()
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 0, 250, 70));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1220, 70, -1, 170));

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/QuizHead.png"))); // NOI18N
        jLabel5.setToolTipText("");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 70, 540, 150));
   ...
   public String   QuizIdGenerator(){
         ...
         int month = now.getMonth()+ 1;
             if(arrayQuizItem.isEmpty()){
                id = "insane" + (year + 1900) + "-" +  month + "/"+date+ "-" + "1101";
        }else{
            ...
            id = "insane" + (year + 1900) + "-"+  month+ "/"+date+ "-" + (Integer.parseInt(arrayLastId[2]) + 1);
        }
