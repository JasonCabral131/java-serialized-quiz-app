...
import Admin.UserUtils.AddUser;
...
import Admin.UserUtils.ViewUser;
...
public class Users extends javax.swing.JFrame {
 ...
 void showDate()
        ...
        public void fillArrayList()  {
         try{
          ...
          DefaultTableModel model = (DefaultTableModel) tbl_admin.getModel();
            for(AdminAndUserModule user: arrayUser){
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1340, 50, 60, 90));
        ...
        jpl_users.setBackground(new java.awt.Color(204, 204, 204));
        ...
        lbl_users.setForeground(new java.awt.Color(51, 204, 255));
        ...
        jLabel28.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/multipleUser.png"))); // NOI18N
        jLabel28.setText("Users Dashboard");
        jPanel1.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 50, 360, 90));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 240, 1000, -1));
 ...
 int xx , xy ;
                ...
                int p = JOptionPane.showConfirmDialog(null, "Are you sure u want to delete this?" , "DELETE QUIZ" , JOptionPane.YES_NO_OPTION);
                    ...
                    if(p == 0){
                           for(int i = 0; i < arrayUser.size() ; i++){
                               if(arrayUser.get(i).getUsername().contains(username)){
                                    arrayUser.remove(i);
    ...
    private void btn_search1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_search1MouseClicked
        ...
        String searchVal  = txt_search.getText();
         for(AdminAndUserModule user: arrayUser){
                    if(user.getUsername().contains(searchVal)){
                         model.addRow(new Object[]{user.getUsername(), user.getLastname(), user.getFirstname()});
                    }
