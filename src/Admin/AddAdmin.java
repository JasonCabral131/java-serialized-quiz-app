...
public class AddAdmin extends javax.swing.JFrame {
        ...
        public boolean isUsernameExist(String username){
         ...
         int month = now.getMonth()+ 1;
             if(arrayAdmin.isEmpty()){
                id = "admin" + (year + 1900) + "-"+ month + "/"+date+ "-" + "1101";
        }else{
            ...
            id = "admin" + (year + 1900) + "-"+ month+ "/"+date+ "-" + (Integer.parseInt(arrayLastId[2]) + 1);
        }
    ...
    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_saveActionPerformed
                ...
                try{
                        admin = new AdminAndUserModule(ID,username,new Service().md5_Password(password),firstname,lastname, "admin");
