   ...
   ArrayList<AdminAndUserModule> arrayAdmin;
    public View() {
        initComponents();
         ...
         lbl_generate1.hide();
         fillArrayList();
         DisplayAdmin( new Service().username );
...
public void fillArrayList()   {
        ...
        public void DisplayAdmin(String username){
  ...
  public boolean isOldPasswordSame(String password){
        boolean isTrue = false;
                      for(int i = 0; i < arrayAdmin.size() ; i++){
                               if(arrayAdmin.get(i).getId().equals(new Service().loginAdminOrUserID)){
